...
public class ProgramTest {
    ...
    @Test
    @DisplayName("GIVEN a time of 21, THEN greeting should return 'Good evening!'") void check21ReturnsGoodEvening(){
        int timeOfDay = 21; 
    ...
    @Test
    @DisplayName("GIVEN a time of over 23, THEN error should be returned with the message 'Time of day can't be more than 23'")
    ...
    @Test
    @DisplayName("GIVEN a time of under 0, THEN error should be returned with the message 'Time of day can't be a negative number'")
